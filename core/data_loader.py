...
class DataLoader(DataProvider):
    ...
    def _get_cache_path(self, symbol: str) -> Path:
        ...
        return (
            CACHE_DIR
            / f"{sanitized}_{self._data_length}_{_MAX_CONTRACTS_PER_PRODUCT}.pkl"
        )
    ...
    def load_csv_files_by_paths(self, file_paths: list) -> pd.DataFrame:
        ...
        # 此前 _finalize_loaded_dfs 只写 self.all_contracts，导致 loader
        # 单品种级使用（不经过 load_data）时 get_pybroker_df 返回空
